const QUERY_KEYS = {
	...
	// user-events
	LIST_USER_ATTENDING_EVENTS_IDS: 'get_LIST_USER_REGISTERED_EVENTS_ids',
	LIST_USER_ATTENDING_EVENTS: 'get_LIST_USER_ATTENDING_EVENTS',
	LIST_USER_CREATED_EVENTS: 'get_LIST_USER_CREATED_EVENTS',
